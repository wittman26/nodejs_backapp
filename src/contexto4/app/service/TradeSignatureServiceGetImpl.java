...
public class TradeSignatureServiceGetImpl implements TradeSignatureServiceGet {
    ...
    @Override
    public Mono<TradeSignature> getTradeSignature(String entity, Long originId, CreateExpedientRequest request) {
        String productId = request.getProductId();
        String origin = tradeSignerHelper.isEventProduct(productId) ? "EVENT" : "TRADE";
    ...
    public Mono<GetTradeSignatureDto> getTradeSignatureResponse(Long tradeSignatureId) {
        if(tradeSignatureId==null) return Mono.empty();
        // Build header
